...
function InitialGuide() {
  return (
    <div className="aspect-x-16 aspect-h-9 mx-10 my-4 px-10 py-4 text-black/80">
      ...
      <div className="flex justify-center items-center">
        <ul className="m-4 p-3 list-disc list-inside bg-[#EFEFEE] rounded-[50px] h-80 w-[50%]">
