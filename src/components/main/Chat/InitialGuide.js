  ...
  return (
    <div className="w-full h-full mx-10 my-4 px-10 py-4 text-[rgb(66,66,66)] dark:text-[rgb(196,196,196)] overflow-auto">
      <div className="font-suit">
        <p className="font-bold font-suit flex justify-center items-center text-[50px]">
      ...
      <div className="flex justify-center items-center h-3/5 mt-2 text-[rgb(115,114,111)] dark:text-[rgb(240,240,240)]">
        <div className="m-4 p-3 bg-[#EFEFEE] rounded-[35px] w-1/2 h-full bg-[rgb(242,242,242)] dark:bg-[rgb(45,47,51)]">
